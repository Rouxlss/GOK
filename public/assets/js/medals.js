...
let bg = [
    'public/assets/img/medals/aces-bg.png',
    'public/assets/img/medals/trebol-bg.png',
    'public/assets/img/medals/corazon-bg.png',
    'public/assets/img/medals/diamante-bg.png',
    'public/assets/img/medals/espada-bg.png',
    'public/assets/img/medals/anima-bg.png',
]
