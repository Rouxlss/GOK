...
const show_character = (index) => {
    ...
    lobby__main_character.src = `public/assets/img/characters/${characters[index]}.png`;
    lobby__main_bg_character.src = `public/assets/img/characters/${characters[index]}.png`;
...
lobby__main_character.src = `public/assets/img/characters/${characters[0]}.png`;
lobby__main_bg_character.src = `public/assets/img/characters/${characters[0]}.png`;
